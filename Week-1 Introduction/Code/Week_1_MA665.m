%%  MA665 - Week 1:  MATLAB Tutorial.
%   This tutorial follows closely Chapter 2 of the textbook "MATLAB for
%   Neuroscientists", and Chapter 1 of the book "Case Studies in Neural 
%   Data Analysis".  If you already know MATLAB, I suggest you quickly work
%   through this tutorial, and confirm you're up to speed.  If you've never
%   used MATLAB (or any other programming language) then I encourage you to
%   work through this tutorial, all of the handout (they're similar), and
%   all of Chapter 1 of "Case Studies in Neural Data Analysis".  We will
%   use MATLAB throughout this course.  And, you'll probably find MATLAB
%   useful in other courses here at BU, as well as throughout your graduate
