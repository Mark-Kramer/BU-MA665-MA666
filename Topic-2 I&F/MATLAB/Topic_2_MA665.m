...
%IN LAB Q:  Does this loop make sense?  Describe what's happening here.  Use
%MATLAB Help if you don't remember the "for" command.

%IN LAB Q:  Why do we end the loop at k=999?
...
%IN LAB Q:  What happens to the voltage after 1000 steps?
...
%IN LAB Q:  What's happening in the command above?  Does it make sense?  (If not,
...
%IN LAB Q:  Adjust the parameter I.  What happens to V(t) if I=0?  Can you set I
...
%IN LAB Q:  What's happening here?  What role does the "if-statement" play?
